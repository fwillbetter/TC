...
def plot_timedomain(wavfile):
    ...
    #####3.构建横坐标
    time = numpy.arange(0, nframes,2) * (1.0 / framerate)
    ...
    pylab.xlabel("Time(s)")
    plt.savefig('G:\\pytorch\\vc-master\\convert-checkpoint\\net1\\Time\\100000_spec_target.png')
    # plt.savefig('G:\\pytorch\\vc-master\\convert-checkpoint\\net1\\Time\\100000_spec_converted.png')
    pylab.show()
    return None
...
def plot_freqdomain(start, fft_size, wavfile):
    ...
    #Python3中，“/”的结果是真正意义上的除法，结果是float型，需要改为“//”
    #### 3.画图
    ...
    pylab.xlabel("Frequence(Hz)")
    plt.savefig('G:\\pytorch\\vc-master\\convert-checkpoint\\net1\\Frequency\\100000_spec_target.png')
    # plt.savefig('G:\\pytorch\\vc-master\\convert-checkpoint\\net1\\Frequency\\100000_spec_converted.png')
    plt.show()


# plot_timedomain(wavfile="G:\\pytorch\\vc-master\\convert-checkpoint\\net1\\ckpt_100000.pth-spec_target.wav")
# plot_timedomain(wavfile="G:\\pytorch\\vc-master\\convert-checkpoint\\net1\\ckpt_100000.pth-spec_converted.wav")

plot_freqdomain(10000, 4000, "G:\\pytorch\\vc-master\\convert-checkpoint\\net1\\ckpt_100000.pth-spec_target.wav")
# plot_freqdomain(10000, 4000, "G:\\pytorch\\vc-master\\convert-checkpoint\\net1\\ckpt_100000.pth-spec_converted.wav")
